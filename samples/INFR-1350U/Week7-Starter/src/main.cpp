...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		shader->SetUniform("s_Diffuse2", 3);

		materials[4].Albedo->Bind(3);
		...
		for(int ix = 0; ix < 4; ix++) {
			...
			shader->SetUniform("u_Mix", materials[ix].mixRatio);
